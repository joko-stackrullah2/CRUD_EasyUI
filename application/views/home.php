...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no">
    ...
    <div data-options="region:'north' "style="height:50px;"><img src="<?php echo base_url("image/logo_new.png"); ?>" height="80%" width="auto" style="margin-left: 30px; margin-top: 5px;">SMKN 1 KEPANJEN</div>
